...
echo "   3. cd $ROOT && npx openvole serve  →  select \"$SPACE_NAME\" and Start it"
echo ""
echo "   Install skills from the space dir: (cd $SPACE && npx openvole clawhub install summarize)"
