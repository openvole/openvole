...
import type { VoleNetDiscovery } from '../src/discovery.js'
import { VoleNetLeader } from '../src/leader.js'
import type { VoleNetInstance, VoleNetMessage } from '../src/protocol.js'
import type { VoleNetTransport } from '../src/transport.js'
...
describe('VoleNetLeader', () => {
	...
	describe('forcedLeader', () => {
		...
		it('forces a specific peer as leader by name', () => {
			discovery = createMockDiscovery([{ id: 'bbbb', name: 'designated-leader' }])
			leader = new VoleNetLeader(
				transport,
				discovery,
				'aaaa',
