...
import { CHUNK_BYTES_DEFAULT, totalChunksFor } from '../src/file-crypto.js'
...
const SERVER = path.join(ROOT, 'src/dashboard-server/src/server.ts')
const FILES = path.join(ROOT, 'src/volenet/src/files.ts')
